...
public class MinionMenu {
    ...
    private ArrayList<Integer> inv = new ArrayList<>(Arrays.asList(21, 22, 23, 24, 25, 30, 31, 32, 33, 34, 39, 40, 41, 42, 43));
    private ArrayList<Integer> fill = new ArrayList<>(Arrays.asList(0, 1, 2, 6, 7, 8, 9, 18, 27, 36, 45, 17, 26, 35, 44, 53, 46, 47, 48, 49, 50, 51, 52, 11, 12, 13, 14, 15, 16, 20, 29, 38));
    private Collection<Integer> workbench = new ArrayList<>(Arrays.asList(12, 13, 14, 21, 22, 23, 30, 31, 32));
    private HashMap<MinionType, ArrayList<int[]>> layouts = new HashMap<>();
    private HashMap<Player, Integer> pages = new HashMap<>();
    private int[] m1m1m1 = new int[3], m1m1 = new int[2], m1 = new int[1];
    private Main plugin;
    ...
    public void createIdealLayout(Player p, PlayerMinion pm) {
        ...
        ItemStack fence = ItemBuilder.item(Material.FENCE, plugin.getLang().get("menus.layout.fence.nameItem"), plugin.getLang().get("menus.layout.fence.loreItem"));
        if (type.equals(MinionType.COLLECTOR) || type.equals(MinionType.SELLER)) {
            ItemStack nothing = ItemBuilder.item(Material.STAINED_GLASS_PANE, plugin.getLang().get("menus.layout.nothing.nameItem"), plugin.getLang().get("menus.layout.nothing.loreItem"));
        ...
        if (type.equals(MinionType.CACTUSCANE)) {
            ItemStack grass = ItemBuilder.item(Material.GRASS, plugin.getLang().get("menus.layout.grass.nameItem"), plugin.getLang().get("menus.layout.grass.loreItem"));
        ...
        if (type.equals(MinionType.MINER)) {
            ItemStack air = ItemBuilder.item(Material.STAINED_GLASS_PANE, plugin.getLang().get("menus.layout.air.nameItem"), plugin.getLang().get("menus.layout.air.loreItem"));
        ...
        if (type.equals(MinionType.FARMER)) {
            ...
            if (pm.getMinion().getPlace().getType().equals(Material.NETHER_WARTS)) {
        ...
        if (type.equals(MinionType.HUNTER)) {
            ItemStack grass = ItemBuilder.item(Material.GRASS, plugin.getLang().get("menus.layout.air.nameItem"), plugin.getLang().get("menus.layout.air.loreItem"));
    ...
    public void createAdminMinionMenu(Player p, PlayerMinion pm) {
        ...
        int slot = MinionUtils.getMaxSlots(pm);
    ...
    private void fillInventoryMinion(Player p, PlayerMinion pm, Minion m, MinionLevel ml, MinionLevel mn, int slot, Inventory inv) {
        ItemStack black = ItemBuilder.item(Material.STAINED_GLASS_PANE, 1, (short) 15, "§7", "§7");
        ItemStack white = ItemBuilder.item(Material.STAINED_GLASS_PANE, 1, (short) 0, plugin.getLang().get("menus.minion.blockedSlot.nameItem"), plugin.getLang().get("menus.minion.blockedSlot.loreItem"));
        ItemStack chest = ItemBuilder.item(Material.STAINED_GLASS_PANE, 1, (short) 0, plugin.getLang().get("menus.minion.chestLinked.nameItem"), plugin.getLang().get("menus.minion.chestLinked.loreItem"));
        ItemStack layout = ItemBuilder.item(Material.REDSTONE_TORCH_ON, 1, (short) 0, plugin.getLang().get("menus.minion.layout.nameItem"), plugin.getLang().get("menus.minion.layout.loreItem"));
        ...
        ItemStack skin = ItemBuilder.item(Material.STAINED_GLASS_PANE, 1, (short) 5, plugin.getLang().get("menus.minion.skin.nameItem"), plugin.getLang().get("menus.minion.skin.loreItem"));
        ItemStack fuel = ItemBuilder.item(Material.STAINED_GLASS_PANE, 1, (short) 1, plugin.getLang().get("menus.minion.fuel.nameItem"), plugin.getLang().get("menus.minion.fuel.loreItem"));
        ItemStack shipping = ItemBuilder.item(Material.STAINED_GLASS_PANE, 1, (short) 11, plugin.getLang().get("menus.minion.shipping.nameItem"), plugin.getLang().get("menus.minion.shipping.loreItem"));
        ItemStack update = ItemBuilder.item(Material.STAINED_GLASS_PANE, 1, (short) 4, plugin.getLang().get("menus.minion.update.nameItem"), plugin.getLang().get("menus.minion.update.loreItem"));
    ...
    public void createMinionLevelMenu(Player p, PlayerMinion pm, MinionLevel next) {
        ...
        ItemStack level = ItemBuilder.item(Material.EXP_BOTTLE, plugin.getLang().get("menus.upgrade.level.nameItem"), plugin.getLang().get("menus.upgrade.level.loreItem").replaceAll("<amount>", String.valueOf(next.getUpgradeLevels())).replaceAll("<level>", Utils.IntegerToRomanNumeral(next.getLevel())));
        ItemStack coins = ItemBuilder.item(Material.DOUBLE_PLANT, plugin.getLang().get("menus.upgrade.coins.nameItem"), plugin.getLang().get("menus.upgrade.coins.loreItem").replaceAll("<amount>", String.valueOf(next.getUpgradeCoins())).replaceAll("<level>", Utils.IntegerToRomanNumeral(next.getLevel())));
        ItemStack craft = ItemBuilder.item(Material.WORKBENCH, plugin.getLang().get("menus.upgrade.craft.nameItem"), plugin.getLang().get("menus.upgrade.craft.loreItem"));
    ...
    public void createPreviewCraftMenu(final Player p, final PlayerMinion pm, MinionLevel l) {
        ...
        ItemStack orange = ItemBuilder.item(Material.STAINED_GLASS_PANE, 1, (short) 15, "§7", "§7");
        ItemStack upgrade = ItemBuilder.item(Material.DOUBLE_PLANT, 1, (short) 0, plugin.getLang().get("menus.craft.upgrade.nameItem"), plugin.getLang().get("menus.craft.upgrade.loreItem"));
