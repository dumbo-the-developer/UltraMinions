...
public class SetupMenu {
    ...
    public void createSetupFuelMenu(Player p, SetupFuel sas) {
        ...
        ItemStack setCraft = ItemBuilder.item(Material.WORKBENCH, plugin.getLang().get("menus.setup.setupFuel.setCraft.nameItem"), plugin.getLang().get("menus.setup.setupFuel.setCraft.loreItem"));
        ...
        ItemStack result = ItemBuilder.item(Material.BREAD, plugin.getLang().get("menus.setup.setupFuel.result.nameItem"), plugin.getLang().get("menus.setup.setupFuel.result.loreItem"));
        ItemStack amount = ItemBuilder.item(Material.DOUBLE_PLANT, plugin.getLang().get("menus.setup.setupFuel.amount.nameItem"), plugin.getLang().get("menus.setup.setupFuel.amount.loreItem").replaceAll("<time>", String.valueOf(sas.getDuration())));
        ItemStack percent = ItemBuilder.item(Material.WATCH, plugin.getLang().get("menus.setup.setupFuel.percent.nameItem"), plugin.getLang().get("menus.setup.setupFuel.percent.loreItem").replaceAll("<percent>", String.valueOf(sas.getPercent())));
    ...
    public void createSetupCompressorMenu(Player p, SetupCompressor sas) {
        ...
        ItemStack setCraft = ItemBuilder.item(Material.WORKBENCH, plugin.getLang().get("menus.setup.setupCompressor.setCraft.nameItem"), plugin.getLang().get("menus.setup.setupCompressor.setCraft.loreItem"));
        ...
        ItemStack amount = ItemBuilder.item(Material.DOUBLE_PLANT, plugin.getLang().get("menus.setup.setupCompressor.amount.nameItem"), plugin.getLang().get("menus.setup.setupCompressor.amount.loreItem").replaceAll("<amount>", String.valueOf(sas.getAmount())));
    ...
    public void createSetupAutoSmeltMenu(Player p, SetupAutoSmelt sas) {
        ...
        ItemStack setCraft = ItemBuilder.item(Material.WORKBENCH, plugin.getLang().get("menus.setup.setupAutoSmelt.setCraft.nameItem"), plugin.getLang().get("menus.setup.setupAutoSmelt.setCraft.loreItem"));
        ...
        ItemStack amount = ItemBuilder.item(Material.DOUBLE_PLANT, plugin.getLang().get("menus.setup.setupAutoSmelt.amount.nameItem"), plugin.getLang().get("menus.setup.setupAutoSmelt.amount.loreItem").replaceAll("<percent>", String.valueOf(sas.getPercent())));
    ...
    public void createSetupAutoSellMenu(Player p, SetupAutoSell sas) {
        ...
        ItemStack setCraft = ItemBuilder.item(Material.WORKBENCH, plugin.getLang().get("menus.setup.setupAutoSell.setCraft.nameItem"), plugin.getLang().get("menus.setup.setupAutoSell.setCraft.loreItem"));
        ...
        ItemStack amount = ItemBuilder.item(Material.DOUBLE_PLANT, plugin.getLang().get("menus.setup.setupAutoSell.amount.nameItem"), plugin.getLang().get("menus.setup.setupAutoSell.amount.loreItem").replaceAll("<percent>", String.valueOf(sas.getSell())));
    ...
    public void createSetupFuelCraftMenu(Player p, SetupFuel sas) {
        ...
        ItemStack black = ItemBuilder.item(Material.STAINED_GLASS_PANE, 1, (short) 15, "§7", "§7");
    ...
    public void createSetupMinionMenu(Player p, SetupMinion sm) {
        ...
        ItemStack lore = ItemBuilder.item(Material.EMPTY_MAP, 1, (short) 0, plugin.getLang().get("menus.setup.minion.lore.nameItem"), getLore(sm));
        ItemStack levels = ItemBuilder.item(Material.EXP_BOTTLE, plugin.getLang().get("menus.setup.minion.levels.nameItem"), plugin.getLang().get("menus.setup.minion.levels.loreItem"));
        ...
        ItemStack entity = ItemBuilder.item(Material.MONSTER_EGG, 1, (short) 50, plugin.getLang().get("menus.setup.minion.entity.nameItem"), plugin.getLang().get("menus.setup.minion.entity.loreItem"));
        ...
        ItemStack autoSellEnabled = ItemBuilder.item(Material.DOUBLE_PLANT, plugin.getLang().get("menus.setup.minion.autoSellEnabled.nameItem"), plugin.getLang().get("menus.setup.minion.autoSellEnabled.loreItem").replaceAll("<state>", Utils.parseBoolean(sm.isAutoSellEnabled())));
        ItemStack smeltEnabled = ItemBuilder.item(Material.FIREBALL, plugin.getLang().get("menus.setup.minion.smeltEnabled.nameItem"), plugin.getLang().get("menus.setup.minion.smeltEnabled.loreItem").replaceAll("<state>", Utils.parseBoolean(sm.isSmeltEnabled())));
        ...
        ItemStack red = ItemBuilder.item(Material.INK_SACK, 1, (short) 1, plugin.getLang().get("menus.setup.minion.red.nameItem"), plugin.getLang().get("menus.setup.minion.red.loreItem").replaceAll("<amount>", String.valueOf(sm.getRed())));
        ItemStack blue = ItemBuilder.item(Material.INK_SACK, 1, (short) 4, plugin.getLang().get("menus.setup.minion.blue.nameItem"), plugin.getLang().get("menus.setup.minion.blue.loreItem").replaceAll("<amount>", String.valueOf(sm.getBlue())));
        ItemStack yellow = ItemBuilder.item(Material.INK_SACK, 1, (short) 10, plugin.getLang().get("menus.setup.minion.green.nameItem"), plugin.getLang().get("menus.setup.minion.green.loreItem").replaceAll("<amount>", String.valueOf(sm.getGreen())));
    ...
    public void createSetupMinionLevelMenu(Player p, SetupMinionLevel sml) {
        ...
        ItemStack workTime = ItemBuilder.item(Material.WOOD_AXE, plugin.getLang().get("menus.setup.minionLevel.workTime.nameItem"), plugin.getLang().get("menus.setup.minionLevel.workTime.loreItem").replaceAll("<amount>", String.valueOf(sml.getWorkTime())));
        ItemStack sleep = ItemBuilder.item(Material.BED, plugin.getLang().get("menus.setup.minionLevel.sleep.nameItem"), plugin.getLang().get("menus.setup.minionLevel.sleep.loreItem").replaceAll("<amount>", String.valueOf(sml.getSleep())));
        ...
        ItemStack isCraft = ItemBuilder.item(Material.WORKBENCH, plugin.getLang().get("menus.setup.minionLevel.isCraft.nameItem"), plugin.getLang().get("menus.setup.minionLevel.isCraft.loreItem").replaceAll("<state>", Utils.parseBoolean(sml.isCraft())));
        ItemStack isLevel = ItemBuilder.item(Material.EXP_BOTTLE, plugin.getLang().get("menus.setup.minionLevel.isLevel.nameItem"), plugin.getLang().get("menus.setup.minionLevel.isLevel.loreItem").replaceAll("<state>", Utils.parseBoolean(sml.isLevel())));
        ItemStack isCoins = ItemBuilder.item(Material.DOUBLE_PLANT, plugin.getLang().get("menus.setup.minionLevel.isCoins.nameItem"), plugin.getLang().get("menus.setup.minionLevel.isCoins.loreItem").replaceAll("<state>", Utils.parseBoolean(sml.isCoins())));
