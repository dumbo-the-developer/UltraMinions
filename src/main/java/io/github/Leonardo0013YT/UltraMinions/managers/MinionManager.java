...
public class MinionManager {
    ...
    public static void createMinion(ItemStack item, int level, int generated, int food, int health, int workTime, int sleep, long fueltime, PlayerMinion pm, Main plugin) {
    ...
    public void loadMinions() {
        ...
        for (File f : dataFolder.listFiles()) {
            ...
            plugin.sendDebugMessage("§ePre Minion §a" + s + "§e has been loaded.");
    ...
    public void createIslandMinion(Player p, Location miLoc) {
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                PlayerMinion pm = new PlayerMinion(p, miLoc, plugin.getCfm().getMinionKey());
                createMinion(item, level, generated, food, health, workTime, sleep, fueltime, pm, plugin);
