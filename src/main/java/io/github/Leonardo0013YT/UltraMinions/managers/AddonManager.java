...
public class AddonManager {
    ...
    public void reload() {
        ...
        if (plugin.getCfm().isHolographicdisplays()) {
            if (Bukkit.getPluginManager().isPluginEnabled("HolographicDisplays")) {
                ha = new HolographicDisplaysAddon(plugin);
            } else {
    ...
    public void createHologram(PlayerMinion pm, Location spawn, List<String> lines) {
        ...
        if (ha != null) {
            ha.createHologram(pm, spawn, (placeholder != null) ? placeholder.parsePlaceholders(pm.getP(), lines) : lines);
        }
        if (plugin.getCfm().isCmiholograms()) {
            cmi.createHologram(pm, spawn, (placeholder != null) ? placeholder.parsePlaceholders(pm.getP(), lines) : lines);
        }
    }
